...
- [ ] **Fase 5.5 — Polish post visual check** — in corso (A.2 fatto `1b95788`). Resta A.1 (splitter ordini 350/750/480), A.3 (padding bottoni Broker), B (refactor Cruscotto per usare panel atomici arricchiti + integra EnginePanel)
